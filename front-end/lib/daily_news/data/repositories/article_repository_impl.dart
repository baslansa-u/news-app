...
/// Responsible for fetching news articles from remote API
/// and handling data transformation into [ArticleModel].
class ArticleRepositoryImpl implements ArticleRepository {
  ...
  ///
  /// Returns [DataSuccess] with a list of [ArticleModel] if successful,
